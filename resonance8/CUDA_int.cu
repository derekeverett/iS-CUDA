/*	int.c
	...
	Changed to device functions so available to the GPU - Matt Golden
*/
...
***************************************************************/
__device__ static	double	gahep4[]  = {	0.524647623275290,	1.650680123885785 };
__device__ static	double	gahew4[]  = {	1.0599644828950,	1.2402258176958 };
__device__ static	double	gahep8[]  = {	0.381186990207322,	1.157193712446780,
						1.981656756695843,	2.930637420257244 };
__device__ static	double	gahew8[]  = {	0.7645441286517,	0.7928900483864,
						0.8667526065634,	1.0719301442480 };
__device__ static	double	gahep16[] = {	0.27348104613815,	0.82295144914466,
						1.38025853919888,	1.95178799091625,
						2.54620215784748,	3.17699916197996,
						3.86944790486012,	4.68873893930582 };
__device__ static	double	gahew16[] = {	0.5473752050378,	0.5524419573675,
						0.5632178290882,	0.5812472754009,
						0.6097369582560,	0.6557556728761,
						0.7382456222777,	0.9368744928841 };
__device__ static	double	gahep20[] = {	0.2453407083009,	0.7374737285454,
...
__device__ static	double	gahew20[] = {	0.4909215006677,	0.4938433852721,
...
__device__ static double gaulep4[] = {	0.8611363115,	0.3399810435	};
__device__ static double gaulew4[] = {	0.3478548451,	0.6521451548	};
__device__ static double gaulep8[] = {	0.9602898564,	0.7966664774,
					0.5255324099,	0.1834346424	};
__device__ static double gaulew8[] = {	0.1012285362,	0.2223810344,
					0.3137066458,	0.3626837833	};
__device__ static double gaulep10[] = {	0.1488743389,	0.4333953941, 
					0.6794095682,	0.8650633666,
							0.97390652	};
__device__ static double gaulew10[] = {	0.2955242247,	0.2692667193,
					0.2190863625,	0.1494513491,
							0.06667134	};
__device__ static double gaulep12[] = {	0.9815606342,	0.9041172563,
					0.7699026741,	0.5873179542,
					0.3678314989,	0.1252334085	};
__device__ static double gaulew12[] = {	0.0471753363,	0.1069393259,
					0.1600783285,	0.2031674267,
					0.2334925365,	0.2491470458	};
__device__ static double gaulep16[] = {
...
__device__ static double gaulew16[] = {
...
__device__ static double gaulep20[] = {
...
__device__ static double  gaulew20[] = {
...
__device__ static double  gaulep48[] = {
...
__device__ static double  gaulew48[] = {
...
__device__  double gauss(int n, double (*f)(double, void*, int*, int, int, double*, double*, double*), double xlo, double xhi, void* optvec, int *partid_d, int npt_max, int nphi_max, double *ptarray_d, double *phiarray_d, double* dN_ptdptdphidy_d )
	...
	for( ix=0; ix<n/2; ix++ ) 	/* n is even */
		s += w[ix] * ( (*f)(xoffs+xdiff*p[ix], optvec, partid_d, npt_max, nphi_max, ptarray_d, phiarray_d, dN_ptdptdphidy_d)
			     + (*f)(xoffs-xdiff*p[ix], optvec, partid_d, npt_max, nphi_max, ptarray_d, phiarray_d, dN_ptdptdphidy_d) );
	return( s * xdiff );
	}
...
__device__ void	gausspts(int n, double xlo, double xhi, double* xvec, double* wvec )
	// int	n;		/* number of points must be even */
	// double	xlo, xhi;	/* limits */
