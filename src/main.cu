...
int main(int argc, char *argv[])
{
   ...
   cout << endl << " -- Created Emission Function Object!" << endl;
   //calculates thermal spectra with GPU
   efa.calculate_dN_ptdptdphidy_GPU();
   cout << endl << " -- calculated spectra"<< endl;
   //efa.calculate_dN_ptdptdphidy_and_flows_4all(9); /*This is for nonGPU calculations*/
