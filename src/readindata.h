...
typedef struct
{
   double tau, xpt, ypt, eta;						//Spacetime coordinate of cell
   double da0, da1, da2, da3;						//Probably normal vector to freezeout surface
   double u0, u1, u2, u3;						//Fluid velocity
   double Edec, Tdec, Pdec;						//Energy, Temp, Pressure
   double Bn, muB, muS;							//Baryon number, chemical potential, strangeness potential
   double pi00, pi01, pi02, pi03, pi11, pi12, pi13, pi22, pi23, pi33;	//Components of \pi^{\mu\nu}
   double bulkPi;							//Bulk viscosity
   double particle_mu[Maxparticle];					//chemical potential for a given particle???
}FO_surf;
